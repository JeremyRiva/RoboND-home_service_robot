...
if("TRUE" STREQUAL "TRUE")
  set(add_markers_SOURCE_PREFIX /home/workspace/catkin_ws/src/add_markers)
  set(add_markers_DEVEL_PREFIX /home/workspace/catkin_ws/devel)
  ...
  set(add_markers_INSTALL_PREFIX /home/workspace/catkin_ws/install)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'add_markers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/workspace/catkin_ws/src/add_markers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    if(NOT add_markers_NUM_DUMMY_TARGETS)
      set(add_markers_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::add_markers::wrapped-linker-option${add_markers_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR add_markers_NUM_DUMMY_TARGETS "${add_markers_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::add_markers::wrapped-linker-option${add_markers_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND add_markers_LIBRARIES "${interface_target_name}")
